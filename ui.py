...
class Menu(Entity):
    def __init__(self, game, **kwargs):
        ...
        game.menu = self
        self.bg = Sprite(texture='assets\\menu_bg.png', parent=self, z=1, color=color.white, scale = 0.1)
        self.title = Text(text="UrsinaCraft", scale=5, parent=self, origin=(0,0), x = 0, y=0.35)
        self.bg_music = Audio('assets\\StockTune-Enchanting Mystic Forest Melody_1728725154.mp3', volume=0.7, loop=True, autoplay=True)  
